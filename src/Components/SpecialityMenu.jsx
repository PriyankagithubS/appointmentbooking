  ...
  return (
      <div className='flex flex-col items-center gap-4 py-16 text-gray-600' id='speciality'>
        <h1 className='text-3xl font-medium'>Find Speciality</h1>
          <p className='sm:w-1/3 text-center text-sm'>Find expert doctors across all specialties and book your appointment in just a few clicks for personalized, hassle-free care.</p>
